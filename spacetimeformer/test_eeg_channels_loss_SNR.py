...
def main(args):
    ...
    REPETITIONS = 10
    #SNRs = ['inf']
    for rep in range(5, REPETITIONS+1):
        for snr in SNRs:
            ...
            for channel in range(CHANNEL_START, CHANNEL_END+1):
                ...
                test_samples, test_samples_unscaled = next(iter(data_module.val_dataloader()))
                ...
                trainer.test(model=forecaster, dataloaders=data_module.val_dataloader(), ckpt_path=checkpoint_path)  # ckpt_path="best"
